...
pipeline {
    ...
    environment {
        PROJECT_PATH = "D:\\Slot-GoldOfEgypt"
    }
        ...
        stage('Checkout') {
            steps {
                script {
                    ...
                    git clone git@github.com:DingDingHouse/Slot-GoldOfEgypt.git D:\\Slot-GoldOfEgypt || echo "Repository already exists, pulling latest changes."
                    cd Slot-GoldOfEgypt
                    git checkout main
                    git fetch --all
