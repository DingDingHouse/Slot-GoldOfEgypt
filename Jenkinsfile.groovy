...
pipeline {
    ...
    environment {
        PROJECT_PATH = "C:\\Games\\Slot-GoldOfEgypt"
        S3_BUCKET = "gold-of-egypt-bucket"
    }
            ...
            steps {
                script {
                    dir("${PROJECT_PATH}") {
                        ...
                        git clone git@github.com:DingDingHouse/Slot-GoldOfEgypt.git C:\\Games\\Slot-GoldOfEgypt || echo "Repository already exists, pulling latest changes."
                        cd C:\\Games\\Slot-GoldOfEgypt
                        git fetch --all
